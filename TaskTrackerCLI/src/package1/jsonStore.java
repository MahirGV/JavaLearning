...
/**
 * JsonStore.java - Reads and writes tasks to/from a JSON file.
 *
 * WHY NO EXTERNAL LIBRARY?
 * The project rules say no external libraries. So we parse JSON manually!
 * This is great for learning — you'll see exactly how JSON works under the hood.
 *
 * THE FILE FORMAT we read/write looks like this:
 * [
 *   {
 *     "id": 1,
